...
\hline \hline
\multirow{3}{*}
{\yellowtext{Local}} &    \redtext{Fail} the computation  & 
                    \redtext{Consume all the answers}, \\
                  &           to the \redtext{current} & 
                                  propagating them to the \\
                  &                         choice point. & 
               context of the \redtext{previous} call. \\
\hline \hline
\multirow{4}{*}
{\yellowtext{Batched}} & \redtext{Consume the answer}, &
                  \redtext{Fail} the computation to \\
                    &       propagating it immediately & 
               the \redtext{previous} choice point, \\
                    &           to the context of the  & 
                                  since the actual was \\
                    &      \redtext{previous} call. & 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\titulo{Private Answer Chaining - Key Ideas}
