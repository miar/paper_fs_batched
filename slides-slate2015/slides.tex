...
\Restriction{\textcolor{myblack}{SLATE 2015, Madrid, Spain}} % left footer
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\titulo{Tabling Scheduling Strategies}

\begin{lista}
\item The two most successful tabling scheduling strategies are
  \redtext{Local} e \redtext{Batched}. They define the behavior of the
  tabling mechanism whenever it finds a \yellowtext{new answer} for a
  tabled call. \\ [0.3cm]
\end{lista}

FAZER FIGURA COM LOCAL VS BATCHED.
CLUSTER THE DEPENDENCIAS EM QUE EM LOCAL AS RESPOSTAS APENAS SAO
CONSUMIDAS SOMENTE APOS TODAS AS RESPOSTAS SEREM ENCONTRADAS. EM
BATCHED É O CONTRARIO
...
\begin{tabular}{|c@{~~~}|c@{~~~}|c|}
\hline
\multirow{3}{*}{\bf {Scheduling}}          &
\multirow{3}{*}{\bf {New Answer}}          & 
\multirow{3}{*}{\bf {Fix-Point Detection}} \\
& & \\
& & \\ 
\hline \hline
\multirow{3}{*}
{\redtext{Local}} &    \yellowtext{Fail} the computation  & 
                    \yellowtext{Consume all the answers}, \\
                  &           to the \yellowtext{current} & 
                                  propagating them to the \\
                  &                         choice point. & 
               context of the \yellowtext{previous} call. \\
\hline \hline
\multirow{4}{*}
{\redtext{Batched}} & \yellowtext{Consume the answer}, &
                  \yellowtext{Fail} the computation to \\
                    &       propagating it immediately & 
               the \yellowtext{previous} choice point, \\
                    &           to the context of the  & 
                                  since the actual was \\
                    &      \yellowtext{previous} call. & 
...
\begin{center}
  ...
  Projects SIBILA: \textit{http://cracs.fc.up.pt/} 

  FCT Grant: \textit{SFRH/BD/69673/2010}
  
  \vspace{0.5cm}
  \includegraphics[width=21.9cm]{\figs/logo.pdf}
\end{center}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%% \titulo{0-1 Knapsack Problem - Top-Down vs Bottom-Up}

%% \vspace{-0.2in}
%% \begin{center}
%% \animategraphics[width=23cm,autoplay,loop]{1}{\figs/knapsack-}{0}{18}
%% \end{center}
